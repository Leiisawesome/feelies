...
def test_summarize_counts_and_rate(mod) -> None:
    records = [
        {"symbol": "APP", "strategy_id": "a", "edge_bps": 40.0,
         "base_target_qty": 100, "tilted_target_qty": 200, "combined_tilt": 2.0},
        {"symbol": "APP", "strategy_id": "b", "edge_bps": 5.0,
         "base_target_qty": 100, "tilted_target_qty": 50, "combined_tilt": 0.5},
    ]
