"""Verify locked parity baselines after fill-model changes.

Verifies the batched parity manifest still matches live replays on the
current tree, including tick-size rounding. The synthetic
...
this file runs the manifest in one CI pass.
"""
