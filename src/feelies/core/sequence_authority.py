...
STREAM_AUTHORITIES: tuple[SequenceAuthority, ...] = (
    ...
    SequenceAuthority("stop_exit", "StopExitController", ("DeRiskRequirement",)),
    SequenceAuthority("hazard_exit", "HazardExitController", ("DeRiskRequirement",)),
    SequenceAuthority("exit_composer", "ExitComposer", ("DeRiskRequirement",)),
    SequenceAuthority("deferral_cap", "DeferralCapController", ("DeRiskRequirement",)),
