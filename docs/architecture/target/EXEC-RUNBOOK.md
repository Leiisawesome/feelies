...
| Baseline capture reports RED with failures in the exempted set | IB after-hours, g12 cost-disclosure, and/or the two live-Massive WebSocket tests (market hours / feed activity) | See LEDGER.md -> EXEMPTIONs for IB after-hours, G12, and live-Massive WebSocket. Not regressions. A failure outside that set is a stop. |
