...
| Baseline capture reports RED with failed == 1 | IB after-hours test, no reachable gateway | See LEDGER.md -> EXEMPTION IB after-hours failure. Not a regression. failed > 1 or a different test is a stop. |
