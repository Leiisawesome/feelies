...
- Last verified: 2026-04-26 (workstream F-3 — operator CLI for ledger inspection)
- Pytest (`-m "not slow"`): **1584 passed, 3 skipped, 6 deselected**
  (+47 new tests for F-3: 32 in `tests/cli/test_promote_cli.py` covering every
  subcommand × text/JSON × happy/sad path, plus 15 in
  `tests/alpha/test_promotion_evidence.py` for the `metadata_to_evidence` /
  `KIND_TO_TYPE` co-evolution; baseline 1537 from F-2)
